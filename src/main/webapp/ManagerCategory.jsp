                    ...
                    <tbody>
                        <c:forEach items="${listC}" var="o">
                            <tr>
                                ...
                                <td>${o.cid}</td>
                                <td>${o.cname}</td>
                                <td>${totalP-o.cnum} products</td>
                                <td>
                                    <a href="loadCategory?cid=${o.cid}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="#" onclick="showMess(${o.cid})" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
